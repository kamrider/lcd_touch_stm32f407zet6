...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, TSCK_Pin|LCD_BL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : TPEN_Pin T_MISO_Pin */
  GPIO_InitStruct.Pin = TPEN_Pin|T_MISO_Pin;
  ...
  /*Configure GPIO pins : W25QXX_CS_Pin LCD_BL_Pin */
  GPIO_InitStruct.Pin = W25QXX_CS_Pin|LCD_BL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
