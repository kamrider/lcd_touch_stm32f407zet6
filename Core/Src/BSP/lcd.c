...
//****************************************************************************************/
//函数：void DisplayButtonDown(uint16_t x1,uint16_t y1,uint16_t x2,uint16_t y2)
//功能描述: 在屏幕显示一凸起的按钮框
...
//****************************************************************************************/
//函数：void DisplayButtonUp(uint16_t x1,uint16_t y1,uint16_t x2,uint16_t y2)
//功能描述: 在屏幕显示一凹下的按钮框
//输    入: uint16_t x1,y1,x2,y2 按钮框左上角和右下角坐标
//输    出: 无
//DevEBox  大越创新
...
void Demo_Menu(void)
{
	...
	Draw_Font16B(48,148,BLUE,(uint8_t*)"3: 图片显示测试");
  
	Draw_Font16B(16,180,RED,(uint8_t*)"F: mcudev.taobao.com");
	Draw_Font16B(16,196,RED,(uint8_t*)"F: shop389957290.taobao.com");
