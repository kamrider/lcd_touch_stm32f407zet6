...
//函数：void Copy_HZK16(uint8_t *Dot, uint8_t num, uint8_t Q, uint8_t W)
...
/**************************************************************************************/
//函数：void Get_HzMat(uint8_t *code,uint8_t *mat,uint8_t size,uint8_t Font)
//函数功能：根据区位码和字号，获取对应的点阵
//参数： 
...
/**************************************************************************************/
//函数：void Show_Font(uint16_t x,uint16_t y,uint8_t *font,uint8_t size,uint16_t color,uint8_t mode)
//函数功能：显示一个指定大小的汉字
//参数：
//x,y :汉字的坐标
//font:汉字区位码
...
/**************************************************************************************/
//函数：Show_Str(uint16_t x,uint16_t y,uint16_t width,uint16_t height,uint8_t*str,uint8_t size, uint16_t color, uint8_t mode)
...
//**************************************************************************************/
//函数：Draw_Font16B(uint16_t x,uint16_t y, uint16_t color, uint8_t*str)
...
//**************************************************************************************/
//函数：void Draw_Font24B(uint16_t x,uint16_t y, uint16_t color, uint8_t*str)
